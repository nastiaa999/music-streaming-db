...
Все ограничения описаны в файле `sql/constraints.sql`

### Триггеры (Triggers)
Для автоматизации бизнес-логики и поддержания денормализованных метрик на уровне СУБД реализованы следующие триггеры (см. `sql/triggers.sql`):
